...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      'POST /api/career-guidance': 'Get career guidance (requires message in body)'
    },
    documentation: 'This API provides career guidance using OpenAI GPT'
  })
})

app.listen(PORT, () => {
  console.log(`🚀 Career Mentor API running on port ${PORT}`)
  console.log(`📱 API available at http://localhost:${PORT}/api/career-guidance`)
